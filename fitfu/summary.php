<?php
$paypal_url='https://github.com/sJalui'; // Test Paypal API URL
$paypal_id='soumiljalui@gmail.com'; // Business email ID
?>
<?php
...
<div id="container">
	<div class="nav">	
			 <ul>
				...
				<li><a href="cardio1.php"> 			 <i class="icon-th-list"></i>Product</a></li>
	...
	<legend></legend>
	<h4>TOTAL: &#8377 <?php echo $amnt; ?></h4>
	</form>
...
<div class="">
    ...
    <input type="hidden" name="item_name" value="FitnessFusion ">
    ...
    <input type="image" src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Google_Pay_Logo.svg/300px-Google_Pay_Logo.svg.png" border="0" name="submit" alt="GooglePay - The safer, easier way to pay online!">
    <img alt="" border="0" src="https://github.com/sJalui" width="1" height="1">
    </form> 
</div>
	</div>
...
<br />
	<div id="footer">
		<div class="foot">
			...
			<p style="font-size:25px;">FitnessFusion Inc. 2024</p>
		</div>
			
			<div id="foot">
				<h4>Links</h4>
					<ul>
						<a href="http://www.facebook.com/FitnessFusion"><li>Facebook</li></a>
						<a href="http://www.twitter.com/FitnessFusion"><li>Twitter</li></a>
						<a href="http://www.pinterest.com/FitnessFusion"><li>Pinterest</li></a>
						<a href="http://www.tumblr.com/FitnessFusion"><li>Tumblr</li></a>
					</ul>
			</div>
	</div>
</body>
